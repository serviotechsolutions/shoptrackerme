...
const POS = () => {
  ...
  return <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="font-bold text-center text-lg">Point of Sale</h1>
          <p className="text-muted-foreground text-center">Fast checkout and sales processing</p>
        </div>
          ...
          <div className="space-y-4">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {cart.length > 0 && <Button className="w-full" variant="outline" onClick={() => setCart([])}>
                    Clear Cart
                  </Button>}
              </CardContent>
            </Card>
