...
const Users = () => {
  ...
  const handleInviteUser = async () => {
    try {
      ...
      const {
        data: profile
      } = await supabase.from('profiles').select('full_name, tenant_id, tenants(name)').single();
      if (!profile) {
  ...
  return <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold tracking-tight text-center">Team Management</h1>
            ...
            <DialogContent>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="full_name" value={newUser.full_name} onChange={e => setNewUser({
                  ...newUser,
